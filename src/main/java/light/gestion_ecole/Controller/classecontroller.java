    ...
    public void initialize() throws SQLException {
        ...
        btnSupprimer.setOnAction(e -> {
            ...
            if (selected != null) {
                ...
                dialog.setHeaderText("Voulez vous vraiment supprimer cette classe ?");
                ...
                dialog.showAndWait().ifPresent(response -> {
                    if (response == yesButton) {
                        try {
                            ...
                            ex.printStackTrace();
                            Notification.showError("Vous ne pouvez pas supprimer une classe ayant déjà des élèves inscrits.");
